    ...
    <div class="py-12 px-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                ...
                <div
                    class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-black/30  ring-white/[0.05] transition duration-300 hover:text-black/70 ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10"
                >
                    <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                ...
                <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-black/30  ring-white/[0.05] transition duration-300 hover:text-black/70 ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                    <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
