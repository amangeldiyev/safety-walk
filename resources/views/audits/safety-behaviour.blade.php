                        ...
                        {{-- @foreach ($keySafetyBehaviours as $behaviour) --}}
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                                    ...
                                    <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-200">BE MINDFUL</h1>
                                ...
                                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                                    ...
                                    <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-200">GET INVOLVED</h1>
                                ...
                                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                                    ...
                                    <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-200">SPEAK OUT</h1>
